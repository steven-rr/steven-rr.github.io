    ...
    return (
        <div className = {AboutCSS.containerMain}>
             ...
             <div className = {AboutCSS.primaryMsg}>
                ...
                <p className={AboutCSS.paragraphText}> I am Steven Rivadeneira, born in Lima, Peru, raised in Miami, FL. I have spent many years in a variety of locations in the U.S learning about technology, making friends, and trying to make a difference in the world.</p>

                <p className={AboutCSS.paragraphText}> Born to tinker, learning new things is a hobby. I also enjoy side quests: writing, running a 10k, and achieving Season 7 Diamond rank (top 1%) in League of Legends. Most importantly, due to the obstacles my family and I once faced, I am passionate about helping others. Being an immigrant who has broken many barriers, I thrive in solving tough challenges that empower others and make the world a better place.</p>
