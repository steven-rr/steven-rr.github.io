...
function Skills() {
    return (
        <div className = {TimelineCSS.containerMain}>
            ...
            positionName= "Candidate for Master's of Science in Aerospace Engineering"
            startDate = "Fall 2019"
            endDate = "Present"
            ...
            sentence2 = "Projects involved in Deep Learning, Autonomy and Flight Controls"
            /> 
            <TimelineItem
            logoImg = {Binera_logo}
            companyName= "Binera"
            positionName= "Data Analyst | Aerospace Engineer"
            ...
            positionName= "Candidate for Bachelor's of Science in Aerospace Engineering"
            startDate = "Fall 2013"
            endDate = "Spring 2017"
